...
CREATE TABLE IF NOT EXISTS users_to_id (
...
CREATE TABLE IF NOT EXISTS friends (
	...
	FOREIGN KEY(USER1) REFERENCES users_to_id(ID),
	FOREIGN KEY(USER2) REFERENCES users_to_id(ID),
...
CREATE TABLE IF NOT EXISTS chatgroup_user(
	...
	FOREIGN KEY(ID_USER) REFERENCES users_to_id(ID)
);
...
CREATE TABLE IF NOT EXISTS chatgroup_message(
	...
	FOREIGN KEY(CHAT_ID) REFERENCES chatgroup(ID),
	FOREIGN KEY(SENDER) REFERENCES users_to_id(ID)
);
...
CREATE TABLE IF NOT EXISTS game_room_players(
	...
	FOREIGN KEY (PLAYER) REFERENCES users_to_id(ID)
);
...
CREATE TABLE IF NOT EXISTS chess_settings(
	...
	FOREIGN KEY(WHITE_PLAYER) REFERENCES users_to_id(ID),
	FOREIGN KEY(BLACK_PLAYER) REFERENCES users_to_id(ID)
);